...
Most environmental data are spatial data. Temperature varies across a landscape. Species are not distributed at random. Pollution doesn't stop at a watershed boundary. Soil properties, precipitation, wildfire risk, habitat quality: all of these vary in space, and that variation is not noise. It has structure. The goal of spatial analysis is to describe that structure, understand it, and use it.

That last part matters. If you treat observations as independent when they're not, you will get the statistics wrong. Standard errors too small, p-values too optimistic, predictions that don't hold up. Spatial analysis gives you the tools to do it right.
...
- **Aside: Correlation and Regression Are Not the Same Thing** -- These two ideas get conflated constantly. This aside untangles them as we start in on correlation anlaysis and before we lean on regression in later chapters.
