...
the last. But scattered through the notes you'll find **Asides**: detours that dig into something that doesn't quite fit the main flow. An Aside might work through the math behind a method, explain how R handles something under the hood, or fill in background that makes the surrounding chapters flow better.
